    ...
    <form class="row g-2 align-items-end" method="get">
        ...
        <div class="col-md-2 d-flex gap-2">
            ...
            @can('create', App\Models\Supplier::class)
                <a class="btn btn-primary flex-fill github-btn" href="{{ route('suppliers.create') }}"><i class="bi bi-plus-lg"></i></a>
            @endcan
        </div>
    </form>
</div>
        ...
        <table class="table table-hover mb-0">
            ...
            @forelse ($suppliers as $supplier)
                <tr>
                    ...
                    <td class="text-end">
                        <a class="btn btn-outline-secondary btn-sm github-btn-icon" href="{{ route('suppliers.show', $supplier) }}" title="Ver"><i class="bi bi-eye"></i></a>
                        @can('update', $supplier)
