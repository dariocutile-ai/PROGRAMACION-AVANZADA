...
<div class="github-panel p-4">
    <dl class="row mb-0">
        ...
        <dt class="col-sm-3" style="color: #8B949E;">Tipo</dt><dd class="col-sm-9"><span class="github-badge-soft">{{ ['purchase'=>'Compra','restock'=>'Reabastecimiento','sale'=>'Venta','waste'=>'Merma'][$movement->type] ?? $movement->type }}</span></dd>
